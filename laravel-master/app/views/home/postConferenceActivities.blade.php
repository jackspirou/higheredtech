...
<div class="container-fluid">
	...
	<div class="container background-color">
		...
		<h3>Schedule:</h3>
		<h4>Day 1 <small>December 20th, MARRAKECH – OUARZAZETE</small></h4>
		<div class="container">
		...
		<h4>Day 2 <small>December 21st, OUARZAZETE - ZAGORA</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 8:30 am: </dt>
				<dd>Complementary breakfast at the hotel</dd>
		...
		<h4>Day 3 <small>December 22nd, ZAGORA - MARRAKECH </small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 7:30 am: </dt>
				<dd>Complementary breakfast at the hotel</dd>
		...
		<h4>Day 4 <small>December 23rd, CASABLANCA or MARRAKECH AIRPORTS</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>All day: </dt>
		...
		<h3>Schedule:</h3>
		<h4>Day 1 <small>December 20th, AESSAOUIRA - AGADIR</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>9:00 am: </dt>
		...
		<h4>Day 2 <small>December 21st, AGADIR - TIZNIT – DESERT</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 8:30 am: </dt>
		...
		<h4>Day 3 <small>December 22nd, AGADIR</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 8:30 am: </dt>
				<dd>Complementary breakfast at the hotel in <strong>AGADIR</strong></dd>
		...
		<h3>Schedule:</h3>
		<h4>Day 1 <small>December 20th, MARRAKECH to FEZ</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>9:00 am: </dt>
		...
		<h4>Day 2 <small>December 21st, FEZ</small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 8:30 am: </dt>
				<dd>Complementary breakfast at the hotel</dd>
		...
		<h4>Day 3 <small>December 22nd, FEZ - CASABLANCA </small></h4>
		<div class="container">
			<dl class="dl-horizontal">
				<dt>Prior 8:30 am: </dt>
