        ...
        <div class="container-fluid">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">The Conference <b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        {{ HTML::nav_link_a_route('conferenceOverview', 'Overview' ) }}
                                        {{ HTML::nav_link_a_route('submissionInformation', 'Submission Information' ) }}
                                        {{ HTML::nav_link_a_route('committee', 'Planning Committee' ) }}
            ...
            <div class="footer">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                    <p class="muted pull-right">Copyright &copy; 2013 Higher Ed TECH. All rights reserved</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
var _gaq=[['_setAccount','UA-53869612-1'],['_trackPageview']];
